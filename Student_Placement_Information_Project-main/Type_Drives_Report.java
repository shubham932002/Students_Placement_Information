...
import java.io.*;
public class Type_Drives_Report
{
    Type_Drives_Report(String dt)
    {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("Drives1.html"));
            ...
            bw.write("<center><h1>DriveType wise Conducted PLacement Drives Information Report</h1></center>");
            bw.write("<br>");
            ...
            bw.write("<th>Appeared Batch Years</th>");
            ...
            String drivesdata[], schdata[], compdata[];
            while((drives = br.readLine()) != null)
            {
                drivesdata = drives.split("\\$");
                if(drivesdata[4].equals(dt))
                {
                    bw.write("<tr>");

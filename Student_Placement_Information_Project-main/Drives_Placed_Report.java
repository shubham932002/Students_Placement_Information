// Porgram to Produce Placement Drive wise Selected Students Information Report
import java.io.*;
public class Drives_Placed_Report
{
    Drives_Placed_Report(String drid)
    {
        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter("Drive_Placed.html"));
            BufferedReader br = new BufferedReader(new FileReader("Placed_Students.txt"));
            BufferedReader br1;
            bw.write("<html>");
            bw.write("<body>");
            bw.write("<center><h1>PCCOER Ravet</h1></center>");     
            bw.write("<center><h1>Placement Drive wise Selected Students Information Report</h1></center>");
            bw.write("<br>");
            ...
            rt.exec("Explorer Drive_Placed.html");
        }
